...
// class="modal fade" id="centralModalSuccess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
//       aria-hidden="true"

// class="modal fade show" id="centralModalSuccess" tabindex="-1" aria-labelledby="myModalLabel" style="display: block;" aria-modal="true" role="dialog"
    ...
    xhr.onload = ()=>{
        if(xhr.status === 200)
        {
            ...
            if(res.res == '0')
            {
                ...
                if(res.count > 0)
                {
                    Tenquiries.innerText = res.count;
                } 
                modal.click();
            }
