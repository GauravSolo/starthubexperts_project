    ...
    <div class="container-fluid mb-5" style="min-height:80vh;" >
      ...
      <div class="row">
                                <div class="col-md-12 text-center mb-3">
                                    <h1 class="admin-heading" style="border-bottom:1px solid black;">ENQUIRIES</h1>
                                </div>
          <div class="col-md-6 mt-4 mx-auto table-responsive">
            ...
            <p class="text-info text-center" id="warn"></p>
      </div>
...
<!-- Remove the container if you want to extend the Footer to full width. -->
  ...
  <!-- End of .container -->
    ...
    <script src="scripts/showenquiries.js"></script>
